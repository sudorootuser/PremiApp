     ...
     <div class="full-box nav-lateral-content">
         <figure class="full-box nav-lateral-avatar">
             ...
             <figcaption class="roboto-medium text-center">
                 <?php echo $_SESSION['firstName_spm'] . " " . $_SESSION['lastName_spm']; ?> <br><small class="roboto-condensed-light"><?php echo $_SESSION['userName_spm']; ?></small>
             </figcaption>
         </figure>
         ...
         <nav class="full-box nav-lateral-menu">
             <ul>
                 ...
                 <?php if ($_SESSION['privilege_spm'] == 1) { ?>
                     <li>
                 ...
                 <?php } ?>
                 <?php if ($_SESSION['privilege_spm'] == 1 || $_SESSION['privilege_spm'] == 2) { ?>
                     <li>
